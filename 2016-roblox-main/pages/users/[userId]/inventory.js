...
const UserInventoryPage = ({ username, userId }) => {
  ...
  const ogUrl = userId ? `https://www.pekora.zip/users/${userId}/inventory` : '';
    ...
    <>
      {username && (
        <Head>
          ...
          <meta property="og:image" content={`https://www.pekora.zip/thumbs/avatar-headshot.ashx?userId=${userId}`} />
