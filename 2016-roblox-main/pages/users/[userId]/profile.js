...
const UserProfilePage = ({ username, userId, description }) => {
  ...
  const ogUrl = userId ? `https://www.roblox.bar/users/${userId}/profile` : '';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`https://www.roblox.bar/thumbs/avatar-headshot.ashx?userId=${userId}`} />
