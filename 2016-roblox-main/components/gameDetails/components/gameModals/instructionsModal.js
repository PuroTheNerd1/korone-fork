...
const instructionsModal = props => {
    ...
    return <>
        {!props.closeModals && <NewModal containerWidth={1000} footerClass={s.footer} exitFunction={props.exitFunction} title="Thanks for playing Pekora" footerElements={<>
            <span style={{ color: 'var(--text-color-secondary)', fontSize: '10px', fontWeight: 600 }}>The Pekora installer should download shortly. If it doesn't, start the <Link href="https://setup.projex.zip/ProjectXPlayerLauncher.exe">
                <a className="link2018" href="https://setup.projex.zip/ProjectXPlayerLauncher.exe">download now.</a>
            </Link></span>
            <span style={{ float: "right", color: 'var(--text-color-secondary)', fontSize: '10px', fontWeight: 600 }}>Having trouble installing? Click <Link href="https://setup.projex.zip/ProjectXPlayerLauncher.exe">
