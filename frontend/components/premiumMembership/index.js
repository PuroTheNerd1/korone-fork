      ...
      <div className={s.layout}>
        <div className={s.leftColumn}>
          <table className={s.table}>
            ...
            <tbody>
              ...
              <tr>
                <td className={s.footnote} colSpan={5}>
        ...
        <div className={s.rightColumn}>
          <div className={s.card}>
            <h3>Buy ROBUX</h3>
            <p>
              ROBUX is the virtual currency used in many of our online games.
              Get cool gear, buy Limited items, and more.
            </p>
            <a href="/robux.aspx" className={s.robuxBtn}>Buy ROBUX</a>
          </div>
          <div className={s.card}>
            <h3>Game Cards</h3>
            <p>Redeem a game card for ROBUX or membership.</p>
            <a href="/gamecard" className={s.redeemLink}>Redeem Card</a>
          </div>
        </div>
      </div>
    </div>
