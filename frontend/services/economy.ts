...
export const getResellers = async ({ assetId, cursor, limit }) => {
 ...
 */
export const purchaseItem = ({ productId, assetId, sellerId, userAssetId, price, expectedCurrency }: {productId: number, assetId: number, sellerId: number, userAssetId: number, price: number, expectedCurrency: number}) => {
...
export const formatSummaryResponse = (resp, type: string | number = 'User') => {
