...
export const multiGetUserThumbnails = ({ userIds, size = '420x420', format = 'png' }: { userIds: number[], size?: string, format?: string }) => {
 ...
 */
export const multiGetUserHeadshots2 = ({ userIds, size = '420x420', format = 'png' }: { userIds: number[], size?: string, format?: string }) => {
...
export const multiGetUserThumbnails3D = ({ userIds, size = '420x420', format = 'png' }: { userIds: number[], size?: string, format?: string }) => {
...
export const multiGetUserHeadshots = ({ userIds, size = '420x420', format = 'png' }: { userIds: number[], size?: string, format?: string }) => {
 ...
 * @returns {Promise<ThumbnailEntry[]>}
 */
export const multiGetOutfitThumbnails = ({ userOutfitIds, size = '420x420', format = 'png' }: { userOutfitIds: number[], size?: string, format?: string }) => {
...
export const multiGetGroupIcons = ({ groupIds }: {groupIds: number[]}) => {
 ...
 * @returns {Promise<ThumbnailEntry[]>}
 */
export const multiGetAssetThumbnails = ({ assetIds }: {assetIds: number[]}) => {
 ...
 * @returns {Promise<ThumbnailEntry[]>}
 */
export const multiGetUniverseIcons2 = ({ universeIds }: {universeIds: number}) => {
...
export const multiGetUniverseIcons = ({ universeIds, size }: {universeIds: number[], size: string}) => {
  let all = [];
