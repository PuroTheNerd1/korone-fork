 ...
 */
export const getUserGames = ({userId, cursor}: {userId: number, cursor: number}) => {
...
export const getGameList = ({sortToken, limit, genre = 0, keyword}: {sortToken: string, limit: number, genre?: number[] | number, keyword?: string}) => {
...
export const getGameTemplates = async () => {
    ...
    return req.data.data as GameTemplate[];
}
