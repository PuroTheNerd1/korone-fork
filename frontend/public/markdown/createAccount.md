Creating an account on Korone is done through an application. This prevents bots and malicious users from joining.
...
* You must have a Discord, and be in the Korone Discord, which you can (join here.)[/auth/discord]
...
4. Enter your Discord ID (Step 3)
   ...
   * Remember that **you must be in the [Korone Discord](/auth/discord)** for verification to be successful.
