## Why is Korone detected as malicious?

The Korone launcher is detected as malicious due to the executable being unsigned. Signed applications are (mostly) exempt from anti-virus detections. 

However, signed applications also cost a (frankly absurd) amount of money, **roughly $400+/year!**

Since Korone does not make any revenue in any way, we cannot afford to sign our launcher. Therefore, anti-viruses tend to be more sensitive towards our launcher.

### Pictures of Korone getting detected as malicious

#### Browsers
![Chrome detecting Korone launcher as dangerous](/img/instructions/mpc-hc64_7rruXWAmDd.png)
![Chrome detecting Korone launcher as dangerous](/img/instructions/3DlQ7incjh.png)
![Firefox detecting Korone launcher as dangerous](/img/instructions/firefox_VHDyU4CeYf.png)
...
1. Go to any game on Korone and download the Korone launcher by clicking **"Play"** then **"Download and Install Korone"**
...
7. The file should now download, and you can open it to install Korone.
...
5. The file should now download, and you can open it to install Korone.

### Windows

On Windows, the best solution is to disable your anti-virus while installing Korone, then set an exclusion path for the **%localappdata%/ProjectX** folder. You can then re-enable your anti-virus.
...
6. Minimize Windows Security and go to any game page and download the Korone launcher by clicking **"Play"** then **"Download and Install Korone"**
...
10.  The Korone folder in Local AppData should now appear with a "Downloads" and "Versions" folder. If not, you need to install Korone. Then, click **"Select Folder"**
...
13.  Turn your Real-time protection back on by clicking the **"Off"** toggle under Real-time protection.
    ...
    *  User Account Control will ask you if you want to allow the app to make changes. Click **"Yes"**
    * ![](/img/instructions/biykjU90CK.png)
14. You can now play any game on Korone by clicking **"Play"** on a game page.