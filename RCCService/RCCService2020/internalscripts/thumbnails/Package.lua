-- Package v1.1.7
-- See http://wiki.korone.zip/index.php?title=R15_Compatibility_Guide#Package_Parts for details on how body parts work with R15
...
poseAnimationId = poseAnimationId or "http://www.korone.zip/asset/?id=532421348"
...
local R15RigUrl = "http://www.korone.zip/asset/?id=516159357"
if useR15 and #R15ArtistIntentAssets > 0 then
	useR15ArtistIntent = true
	R15RigUrl = "http://www.korone.zip/asset/?id=1664543044"
end
