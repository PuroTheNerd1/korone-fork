...
local enUS =
{
	...
	["AuthHttpErrorDetected"] = "Trouble communicating with ROBLOX servers. Please check www.korone.zip/help/xbox for more info.";
	...
	["ToSInfoLinkPhrase"] = "Terms & Privacy Policy:\nwww.korone.zip/info/terms-of-service\nwww.korone.zip/info/Privacy.aspx";
	...
	["PlayMyPlaceMoreGamesPhrase"] = "Sign in on korone.zip to create more games and edit your existing creations!";
