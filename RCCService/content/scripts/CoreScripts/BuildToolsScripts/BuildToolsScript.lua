...
if BaseUrl:find("www.roblox.bar") or BaseUrl:find("gametest1") then
...
function showBuildToolsTutorial()
	...
	local firstPage = RbxGui.CreateImageTutorialPage(" ", "http://www.roblox.bar/asset/?id=59162193", 359, 296, function() dismissTutorial() end, true)
