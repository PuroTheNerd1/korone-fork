...
if BaseUrl:find("www.korone.zip") or BaseUrl:find("gametest1") then
...
function showBuildToolsTutorial()
	...
	local firstPage = RbxGui.CreateImageTutorialPage(" ", "http://www.korone.zip/asset/?id=59162193", 359, 296, function() dismissTutorial() end, true)
