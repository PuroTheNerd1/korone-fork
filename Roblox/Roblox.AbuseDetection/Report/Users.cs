...
public static class UsersAbuse
{
    ...
    private const int CreatedLastHourThresholdForDisable = 10;
    private const int CreatedLastDayThresholdForDisable = 35;
    private const int UserCreationAllowedAttemptsPerHour = 5;
