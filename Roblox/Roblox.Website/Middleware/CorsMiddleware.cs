...
public class RobloxPlayerCorsMiddleware
{
    ...
    private string GenerateCspHeader(bool isAuthenticated)
    {
        ...
        var scriptSrc =
            "'unsafe-eval' 'self' https://challenges.cloudflare.com/turnstile/v0/api.js https://hcaptcha.com https://*.hcaptcha.com https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js https://projex.zip   http://*.archive.org https://*.archive.org http://js.rbxcdn.com/46eace8231bf3c1ce64c55407d9ae60d.js";
