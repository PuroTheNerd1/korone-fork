...
public class RobloxPlayerCorsMiddleware
{
    ...
    {
        var connectSrc = "'self' https://*.korone.zip wss://*.korone.zip https://hcaptcha.com https://*.hcaptcha.com https://*.cdn.com https://*.archive.org/* https://web.archive.org https://challenges.cloudflare.com/* ws://localhost:*";

        var imgSrc = "'self' data: https://cdn.discordapp.com";
        if (isAuthenticated)
        {
            imgSrc += " https://*.korone.zip https://*.cdn.com https://*.archive.org http://*.archive.org https://challenges.cloudflare.com/*";
        }

        var scriptSrc =
            "'unsafe-eval' 'self' https://challenges.cloudflare.com/turnstile/v0/api.js https://translate.google.com https://hcaptcha.com https://*.hcaptcha.com https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js https://korone.zip http://*.archive.org https://*.archive.org http://js.rbxcdn.com/46eace8231bf3c1ce64c55407d9ae60d.js";
        scriptSrc += " https://cdn.jsdelivr.net/npm/cryptocoins-icons@2.9.0/gulpfile.min.js";

        var fontSrc = "'self' https://fonts.gstatic.com https://cdn.jsdelivr.net http://www.korone.zip https://korone.zip https://*.korone.zip https://www.korone.zip/fonts/GothamSSmBold.woff2 https://www.korone.zip/fonts/GothamSSmMedium.woff2 https://www.korone.zip/fonts/GothamSSmBook.woff2";
        ...
        return "default-src 'self'; img-src " + imgSrc + "; child-src 'self'; script-src " + scriptSrc + "; frame-src 'self' https://hcaptcha.com https://challenges.cloudflare.com http://challenges.cloudflare.com https://*.archive.org; style-src 'unsafe-inline' 'self' http://*.archive.org https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com https://korone.zip https://www.korone.zip https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css https://cdn.jsdelivr.net/gh/AllienWorks/cryptocoins@2.7.0/webfont/cryptocoins.css https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css https://korone.zip/fonts/gotham1.css http://*.korone.zip" + styleSrc + "; font-src " + fontSrc + "; connect-src " + connectSrc + "; worker-src 'self';";
    }
