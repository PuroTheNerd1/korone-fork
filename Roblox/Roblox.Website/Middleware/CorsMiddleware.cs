...
public class RobloxPlayerCorsMiddleware
{
    ...
    {
        var connectSrc = "'self' https://*.roblox.bar wss://*.roblox.bar https://hcaptcha.com https://*.hcaptcha.com https://*.cdn.com https://*.archive.org/* https://web.archive.org https://challenges.cloudflare.com/*";
#if DEBUG
        ...
        if (isAuthenticated)
        {
            imgSrc += "  https://*.cdn.com https://*.archive.org http://*.archive.org https://challenges.cloudflare.com/*";
        }
        ...
        var scriptSrc =
            "'unsafe-eval' 'self' https://challenges.cloudflare.com/turnstile/v0/api.js https://hcaptcha.com https://*.hcaptcha.com https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js https://roblox.bar   http://*.archive.org https://*.archive.org http://js.rbxcdn.com/46eace8231bf3c1ce64c55407d9ae60d.js";
