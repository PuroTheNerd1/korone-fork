...
public class RbxThumbnails : ControllerBase
{
    ...
    public async Task<dynamic> BatchThumbnailsRequest([FromBody] IEnumerable<BatchRequestEntry> request)
    {
        ...
        var allResults = await Task.WhenAll(new List<Task<IEnumerable<dynamic>>>()
        {
            ...
            MultiGetThumbnailsGeneric(thumbs, "AutoGeneratedGameIcon", services.thumbnails.GetGameIcons),
            MultiGetThumbnailsGeneric(thumbs, "ForceAutoGeneratedGameIcon", services.thumbnails.GetGameIcons),
            ...
            MultiGetThumbnailsGeneric(thumbs, "AutoGeneratedAsset", services.thumbnails.GetGameIcons),
