...
namespace Roblox.Website.Controllers.Internal
{
    public class SignatureController : ControllerBase
    {
        ...
        public static string SignJson2048New(dynamic JSONToSign)
        {
            string script = newLine + JsonConvert.SerializeObject(JSONToSign);
        ...
        public static string SignString2048New(string stringToSign, bool bUseRbxSig = false)
        {
            if (bUseRbxSig)
            {
                string script = newLine + stringToSign;
        ...
        public static string GenerateClientTicketV4(long userId, string username, string characterAppearanceUrl, string membership, string jobId, string dateTime, long accountAgeDays, long placeId)
        {
